                ...
                <div className="right-page-theory">
                    {selectedAdventure ? (
                        <div className="adventure-detail">
                            <h2 className="progress-h2">{selectedAdventure.name}</h2>
                            <p className="progress-p">{selectedAdventure.adventure_text}</p>
                            <div className="progress-button">
                                <BookButton text={"Вперёд!"} onClick={()=>{
                                    navigate("/adventure?adventureId=" + selectedAdventure.id);
                                }}/>
                            </div>

                        </div>
                    ) : (
                        <p className="theory-p">Select an adventure to view the story.</p>
                    )}
                </div>
            </div>
        </>
